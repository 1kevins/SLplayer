...
Pod::Spec.new do |s|
  ...
  s.description  = "SLPlayer is A multi-function music player. "
 ...
 #s.license      = "MIT (example)"
  ...
  s.author             = { "kevin.lai" => "kevin.lai@earlylight.com.hk" }
  # Or just: s.author    = "kevin.lai"
  # s.authors            = { "kevin.lai" => "kevin.lai@earlylight.com.hk" }
  # s.social_media_url   = "http://twitter.com/kevin.lai"
